...
export async function GET() {
  ...
  const { data, error } = await supabase
    .from("words")
    .select("id, hanzi, pinyin, english, description, sentence, category_id, lesson_id, category:categories!words_category_id_fkey(id, name), lesson:lessons!words_lesson_id_fkey(id, name)")
